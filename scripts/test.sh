...
CUDA_VISIBLE_DEVICES=0 python src/train/train_sft.py \
    ...
    --num_lora_modules -1 \
    --model_id $MODEL_NAME \
    --data_path /home/guanxw/data/Skywork/CSVQA/train/train.json \
    --eval_data_path /home/guanxw/data/Skywork/CSVQA/test/test.json \
    --image_folder /home/guanxw/data/Skywork/CSVQA/image \
    ...
    --output_dir ./output/chatqa/qwen2_5_vl_kradapter_test \
    --max_steps 700 \
    ...
    --do_final_eval True \
    --test_data_path /home/guanxw/data/Skywork/CSVQA/test/test.json